...
CARBON.showWarningDialog = function(message, callback, closeCallback) {
    ...
    var strDialog = "<div id='dialog' title='HRTA 경고'><div id='messagebox-warning'><p>" +
                    message + "</p></div></div>";
...
CARBON.showErrorDialog = function(message, callback, closeCallback) {
    var strDialog = "<div id='dialog' title='HRTA 에러'><div id='messagebox-error'><p>" +
                    message + "</p></div></div>";
...
CARBON.showInfoDialog = function(message, callback, closeCallback) {
    ...
    var strDialog = "<div id='dialog' title='HRTA 정보'><div id='messagebox-info'><p>" +
                     message + "</p></div></div>";
...
CARBON.showConfirmationDialog = function(message, handleYes, handleNo, closeCallback){
     ...
     * parameter.
     */
    var strDialog = "<div id='dialog' title='HRTA 확인'><div id='messagebox-confirm'><p>" +
                    message + "</p></div></div>";
...
CARBON.showInputDialog = function(message, handleOk, handleCancel, closeCallback){
    ...
    var strDialog = "<div id='dialog' title='HRTA 입력'>" + strInput + "</div>";
    var func = function() {   
	    jQuery("#dcontainer").html(strDialog);
	    jQuery("#dialog").dialog({
	        close:function() {
