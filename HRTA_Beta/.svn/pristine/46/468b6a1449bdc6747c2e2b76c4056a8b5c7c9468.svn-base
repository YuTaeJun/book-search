...
function showMessageConfigProperties(streamNameWithVersion) {
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../hrta_eventbuilder/hrta_get_mappings_ajaxprocessor.jsp?eventAdaptorName=" + selected_text + "",
                    data:{},
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../hrta_eventbuilder/hrta_get_properties_ajaxprocessor.jsp?eventName=" + selected_text + "",
                    data:{},
                    contentType:"application/json; charset=utf-8",
                    dataType:"text",
                    async:false,
...
function loadMappingUiElements(streamNameWithVersion) {
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../hrta_eventbuilder/hrta_get_mapping_ui_ajaxprocessor.jsp?mappingType=" + inputMappingType + "&streamNameWithVersion=" + streamNameWithVersion,
                    data:{},
    ...
    if (selectedVal == 'createStreamDef') {
        ...
        new Ajax.Request('../hrta_eventstream/hrta_popup_create_event_stream_ajaxprocessor.jsp', {
            ...
            onSuccess:function (data) {
                showCustomPopupDialog(data.responseText, "스트림 정의 생성", "80%", "", onSuccessCreateStreamDefinition, "90%");
            }
        });
    }
}
