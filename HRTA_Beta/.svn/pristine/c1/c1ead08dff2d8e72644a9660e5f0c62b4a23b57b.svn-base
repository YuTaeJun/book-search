...
<script type="text/javascript">
    function updateConfiguration(form, eventName) {
        ...
        new Ajax.Request('../hrta_input_adaptor/hrta_edit_event_ajaxprocessor.jsp', {
            method:'POST',
            asynchronous:false,
...
<div id="cols">
	...
	<div class="act">
        ...
        <form name="configform" id="configform" action="../hrta_input_adaptor/hrta_input_adaptor.jsp?ordinal=1" method="post">            
