...
function showEventStreamDefinition() {
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../hrta_eventformatter/hrta_get_streamdefinition_ajaxprocessor.jsp?streamName=" + selected_text + "",
                    data:{},
...
function loadEventAdaptorRelatedProperties(toPropertyHeader) {
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../hrta_eventformatter/hrta_get_mappings_ajaxprocessor.jsp?eventAdaptorName=" + selected_text + "",
                    data:{},
                    contentType:"application/json; charset=utf-8",
                    dataType:"text",
                    async:false,
...
// delete message properties related fields
    ...
    jQuery.ajax({
                    type:"POST",
                    url:"../hrta_eventformatter/hrta_get_message_properties_ajaxprocessor.jsp?eventAdaptorName=" + selected_text + "",
                    data:{},
                    contentType:"application/json; charset=utf-8",
                    dataType:"text",
                    async:false,
